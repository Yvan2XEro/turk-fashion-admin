...
interface DataTableProps<TData, TValue> {
  columns: ColumnDef<TagObj, TValue>[];
  data: TagObj[];
}

export function DataTable<TagObj, TValue>({
  columns,
  data,
}: DataTableProps<TagObj, TValue>) {
        ...
        <Alert className="flex justify-end gap-2">
          <Button
            onClick={async () => {
              ...
              await deleteMultipleTags(selecteItems.map((e: any) => e.uuid));
              setRowSelection({});
            }}
            variant="destructive"
            size="sm"
